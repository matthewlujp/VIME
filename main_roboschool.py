...
conf_d = toml.load(open(args.config))
    ...
    while not done:
        ...
        if len(memory) > args.batch_size:
            ...
            for i in range(args.updates_per_step):
                ...
                q1_loss, q2_loss, policy_loss, alpha_loss, alphas = agent.update_parameters(batch_data, updates)
        ...
        memory.append(state, action, reward, next_state, bool(1. - mask)) # Append transition to memory
